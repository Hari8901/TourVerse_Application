...
public class OtpService {
	...
	public String generateOtp(String key) {
		...
		redisTemplate.opsForValue().set(OTP_PREFIX + key, otp, OTP_VALIDITY_MINUTES, TimeUnit.MINUTES);
		return otp;
	}

	public boolean validateOtp(String key, String otp) {
		String cachedOtp = (String) redisTemplate.opsForValue().get(OTP_PREFIX + key);
